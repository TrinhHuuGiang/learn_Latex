...
\begin{itemize}
    ...
    \begin{description}
        \item[description] This is \textbf{description} list
        \item[lorem paragraph 3] \lipsum[3]
        \item item
    \end{description}
